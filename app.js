...
id:p._id||p.id, area:p.area||[p.village,p.city].filter(Boolean).join(’ - ‘), phone:p.phone, wa:p.wa||p.phone,
exp:p.experience||p.exp||’’, desc:p.description||p.desc||’’,
avail:!p.isBusy, verified:p.verified||false,
